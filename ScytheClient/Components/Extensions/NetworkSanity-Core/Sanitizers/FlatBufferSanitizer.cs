...
namespace NetworkSanity.Sanitizers
{
    internal class FlatBufferSanitizer : ISanitizer
    {
        ...
        public FlatBufferSanitizer()
        {
            ...
            {
                // Methode Change 1
                var originalMethod = (Il2CppMethodInfo*)(IntPtr)UnhollowerUtils.GetIl2CppMethodInfoPointerFieldForGeneratedMethod(typeof(PoseRecorder).GetMethod(nameof(PoseRecorder.Method_Public_byref_HumanPose_0))).GetValue(null);
            ...
            //Methode 2 Changed
            ScytheStation.Main.Harmony.Patch(typeof(FlatBufferNetworkSerializer).GetMethod(nameof(FlatBufferNetworkSerializer.Method_Public_Void_EventData_ArrayOf_Byte_0)), typeof(FlatBufferSanitizer).GetMethod(nameof(FlatBufferNetworkSerializeReceivePatch), BindingFlags.NonPublic | BindingFlags.Static).ToNewHarmonyMethod());
            ScytheStation.Main.Harmony.Patch(typeof(FlatBufferNetworkSerializer).GetMethod(nameof(FlatBufferNetworkSerializer.Method_Public_Void_EventData_ArrayOf_Byte_0)), typeof(FlatBufferSanitizer).GetMethod(nameof(FlatBufferNetworkSerializeReceivePatch13), BindingFlags.NonPublic | BindingFlags.Static).ToNewHarmonyMethod());
            ScytheStation.Main.Harmony.Patch(typeof(FlatBufferNetworkSerializer).GetMethod(nameof(FlatBufferNetworkSerializer.Method_Public_Void_EventData_ArrayOf_Byte_0)), typeof(FlatBufferSanitizer).GetMethod(nameof(FlatBufferNetworkSerializeReceivePatch12), BindingFlags.NonPublic | BindingFlags.Static).ToNewHarmonyMethod());
        }
