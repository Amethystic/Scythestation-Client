...
namespace ScytheStation.Core.Discord
{
    internal class DiscordRpc
    {
        ...
        [DllImport("ScytheStation\\Dependencies\\discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Initialize")]
        ...
        [DllImport("ScytheStation\\Dependencies\\discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Shutdown")]
        internal protected static extern void Shutdown();

        [DllImport("ScytheStation\\Dependencies\\discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_RunCallbacks")]
        internal protected static extern void RunCallbacks();

        [DllImport("ScytheStation\\Dependencies\\discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_UpdatePresence")]
        internal protected static extern void UpdatePresence(ref DiscordRpc.RichPresence presence);

        [DllImport("ScytheStation\\Dependencies\\discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_ClearPresence")]
        internal protected static extern void ClearPresence();

        [DllImport("ScytheStation\\Dependencies\\discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Respond")]
