...
namespace ScytheStation.Functions
{
    internal static class GameControls
    {
        ...
        {
            TargeteEvent("KillLocalPlayer", IUserExtension.SelectedVRCPlayer());
        }
        public static void VotePlayerOut()
        {
            TargeteEvent("SyncVotedOut", IUserExtension.SelectedVRCPlayer());
        }
        ...
        {
                TargeteEvent("SyncVictoryM", IUserExtension.SelectedVRCPlayer());
        }
        public static void TargetWinnerB()
        {
                TargeteEvent("SyncVictoryB", IUserExtension.SelectedVRCPlayer());
        }
