...
namespace ScytheStation.Menus
{
    internal class Game
    {
        public static void Init(QMTabMenu menu)
        {
            ...
            new QMSingleButton(AnotherMenu2, 4, 3, "<color=#fcf403><b>Load Config</b></color>", delegate { MelonLogger.Msg("[GC] Config Loaded"); Components.Settings2.LoadSettings(); }, "Load");
            new QMSingleButton(AnotherMenu2, 4, 2, "<color=#b83275><b>Open Site</b></color>", delegate { Functions.GameControls.OpenSite(); }, "Opens our site");
            /* Main Settings Buttons */
            /* Settings Buttons */
